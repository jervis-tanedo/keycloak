...
<@layout.registrationLayout displayInfo=false displayMessage=false; section>
    ...
    <#elseif section = "form">
        <#if realm.password>
            <div class="container">
                <div id="loginbox" style="margin-top:100px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2" style="background-color: #8D1436; color: #FFF;">
                    <div class="panel panel-info" style="border-color: #8D1436;">
                        <div class="panel-heading" style="background-color: #8D1436; color: #fff; border-color: #8D1436;">
                            <div class="panel-title" style="background-color: #8D1436; color: #fff;">Sign In</div>
                        ...
                        <div class="panel-body" >
                            ...
                            <form id="kc-form-login" class="${properties.kcFormClass!}" onsubmit="login.disabled = true; return true;" action="${url.loginAction?keep_after('^[^#]*?://.*?[^/]*', 'r')}" method="post">
                                ...
                                <div id="kc-form-buttons" style="margin-top:10px" class="${properties.kcFormButtonsClass!}" style="display: flex; justify-content: center;">
                                    <div class="${properties.kcFormButtonsWrapperClass!}">
                                        <input tabindex="4" class="${properties.kcButtonClass!}" style="background-color: #8D1436 !important; color: #fff; display:block; width:100%" name="login" id="kc-login" type="submit" value="${msg("doLogIn")}"/>
                                    ...
                                    <div class="${properties.kcFormButtonsWrapperClass!}">
                                        <#if realm.password && social.providers??>
                                            <#list social.providers as p>
                                                <a href="${p.loginUrl}" id="zocial-${p.alias}" class="btn" style="display:block; width:100%; color: #8D1436 !important;"><i class="fab fa-google"></i> ${msg("doLogIn")} With ${p.displayName}</a>
                                            </#list>
                                        </#if>
                                    </div>
                                </div>
