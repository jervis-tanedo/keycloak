    ...
    <#elseif section = "socialProviders" >
        <#if realm.password && social.providers??>
            <div id="kc-social-providers" class="${properties.kcFormSocialAccountSectionClass!}">
                <h3 class="pb-3">Our authentication system utilizes Google login using UP mail for user verification</h3>
                <hr/>
                <h4 class="pb-3">${msg("identity-provider-login-label")}</h4>
